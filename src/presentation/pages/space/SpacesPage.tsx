...
export const SpacesPage: React.FC = () => {
                    ...
                    >
                        {spaces.map((space) => (
                            <Link
                                key={space.id}
                                to={`/space/${space.id}`}
                                className="flex-shrink-0 w-72 sm:w-80 bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-200 overflow-hidden transition-all duration-300 hover:border-primary group"
                            >
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="bg-gradient-to-r from-primary to-secondary text-white py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8">
                        ...
                        {[...Array(4)].map((_, i) => (
                            <div key={i} className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden animate-pulse">
                                <div className="flex flex-col sm:flex-row">
                                    {/* Image Skeleton */}
                                    <div className="w-full sm:w-72 h-56 sm:h-64 bg-gray-300 flex-shrink-0" />
                                    {/* Content Skeleton */}
                    ...
                    <div className="space-y-4">
                        {filteredSpaces.map((space) => (
                            ...
                            >
                                <div className="flex flex-col sm:flex-row">
                                    {/* Image Section */}
                                    <div className="relative w-full sm:w-72 md:w-80 h-56 sm:h-64 flex-shrink-0 overflow-hidden bg-gray-100">
                                        {space.images && space.images.length > 0 ? (
                                            <img
                                                src={space.images[0]}
                                                alt={space.title}
