        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              La plataforma líder en Cancún para rentar espacios temporales. Conectamos propietarios con personas que buscan el lugar perfecto.
            </p>
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-4">
              Suscríbete para recibir las mejores ofertas y noticias.
            </p>
            <form className="space-y-3">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-800 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-secondary transition-all"
                />
              </div>
              <button
                type="submit"
                className="w-full px-4 py-3 bg-gradient-to-r from-secondary to-primary text-white rounded-lg font-semibold text-sm hover:shadow-lg hover:scale-105 transition-all duration-200"
              >
                Suscribirse
              </button>
            </form>
